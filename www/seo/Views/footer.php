            ...
            <div class="desktop-footer-top">
                ...
                <div>
                    <div>
                            ...
                            <label class="sc-label-md-h sc-label-md-s md"><a href="/page/contacts" class="">Контакты</a></label>
                        
                    </div>
                    <div>
                        
                            <label class="sc-label-md-h sc-label-md-s md"><a href="/page/rules-customer" class="">Правила пользования</a></label>
                        
                    </div>
                    <div>
                        
                            <label class="sc-label-md-h sc-label-md-s md"><a href="/page/privacy_policy" class="">Политика конфиденциальности</a></label>
