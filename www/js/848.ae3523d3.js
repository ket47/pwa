 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ke="firebase-installations-database",Ie=1,Se="firebase-installations-store";let Te=null;function De(){return Te||(Te=B(ke,Ie,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Se)}}})),Te}async function Ce(e,t){const n=le(e),i=await De(),o=i.transaction(Se,"readwrite"),r=o.objectStore(Se),a=await r.get(n);return await r.put(t,n),await o.done,a&&a.fid===t.fid||we(e,t.fid),t}async function Ee(e){const t=le(e),n=await De(),i=n.transaction(Se,"readwrite");await i.objectStore(Se).delete(t),await i.done}async function je(e,t){const n=le(e),i=await De(),o=i.transaction(Se,"readwrite"),r=o.objectStore(Se),a=await r.get(n),s=t(a);return void 0===s?await r.delete(n):await r.put(s,n),await o.done,!s||a&&a.fid===s.fid||we(e,s.fid),s}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const jt="/firebase-messaging-sw.js",_t="/firebase-cloud-messaging-push-scope",Pt="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",At="https://fcmregistrations.googleapis.com/v1",Ot="google.c.a.c_id",Nt="google.c.a.c_l",Mt="google.c.a.ts",Bt="google.c.a.e";var Kt,Lt;
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vn(e){return"object"===typeof e&&!!e&&Ot in e}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */kn("hts/frbslgigp.ogepscmv/ieo/eaylg","tp:/ieaeogn-agolai.o/1frlglgc/o"),kn("AzSCbw63g1R0nCw85jG8","Iaya3yLKwmgvh7cF0q4");class Tn{constructor(e,t,n){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const i=In(e);this.firebaseDependencies={app:e,appConfig:i,installations:t,analyticsProvider:n}}_delete(){return Promise.resolve()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dn(e){var t;try{e.swRegistration=await navigator.serviceWorker.register(jt,{scope:_t}),e.swRegistration.update().catch((()=>{}))}catch(n){throw tn.create("failed-service-worker-registration",{browserErrorMessage:null===(t=n)||void 0===t?void 0:t.message})}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cn(e,t){if(t||e.swRegistration||await Dn(e),t||!e.swRegistration){if(!(t instanceof ServiceWorkerRegistration))throw tn.create("invalid-sw-registration");e.swRegistration=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _n(e,t,n){const i=Pn(t),o=await e.firebaseDependencies.analyticsProvider.get();o.logEvent(i,{message_id:n[Ot],message_name:n[Nt],message_time:n[Mt],message_device_time:Math.floor(Date.now()/1e3)})}function Pn(e){switch(e){case Lt.NOTIFICATION_CLICKED:return"notification_open";case Lt.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function An(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===Lt.PUSH_RECEIVED&&("function"===typeof e.onMessageHandler?e.onMessageHandler(hn(n)):e.onMessageHandler.next(hn(n)));const i=n.data;vn(i)&&"1"===i[Bt]&&await _n(e,n.messageType,i)}const On="@firebase/messaging",Nn="0.9.14",Mn=e=>{const t=new Tn(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",(e=>An(t,e))),t},Bn=e=>{const t=e.getProvider("messaging").getImmediate(),n={getToken:e=>jn(t,e)};return n};function Kn(){(0,g.Xd)(new w.wA("messaging",Mn,"PUBLIC")),(0,g.Xd)(new w.wA("messaging-internal",Bn,"PRIVATE")),(0,g.KN)(On,Nn),(0,g.KN)(On,Nn,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
